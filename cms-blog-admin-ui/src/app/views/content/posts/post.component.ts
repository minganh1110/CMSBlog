...
export class PostComponent implements OnInit, OnDestroy {
  ...
  public selectedCategory: PostCategoryDto | null = null;
  ...
  loadData(selectionId = null) {
    ...
    const categoryIdToSend = this.selectedCategory?.id ?? '';
    this.postApiClient.getPostsPaging(this.keyword, categoryIdToSend, this.pageIndex, this.pageSize)
