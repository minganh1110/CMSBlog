...
namespace CMSBlog.Data.Migrations
{
    ...
    [Migration("20251203094546_AddMediaFormatsToAssets")]
    partial class AddMediaFormatsToAssets
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CMSBlog.Core.Application.DTOs.Media.MediaSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2025, 12, 3, 9, 45, 46, 100, DateTimeKind.Utc).AddTicks(795)
                        });
                });
